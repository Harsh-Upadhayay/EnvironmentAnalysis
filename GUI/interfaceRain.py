...
def countryBox(Frame):
    ...
    scale_label = tkinter.Label(f1, text="From Year ").grid(
        row=1, column=0)
...
def countriesBox(Frame):
    ...
    scale1_label = tkinter.Label(
        f2, text="From Year").grid(row=2, column=0)
...
def stateBox(Frame):
    ...
    y_label = tkinter.Label(f3, text="From Year").grid(row=2, column=0)
...
def statesBox(Frame):
    ...
    state_s_label = tkinter.Label(
        f4, text="From Year").grid(row=3, column=0)
