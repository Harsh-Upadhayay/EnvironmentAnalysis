...
def TempNotebook(Tempframe):
    ...
    GlobalNotebook = tkinter.Frame(Tempframe,bg='turquoise2')
    ...
    GlobalWBDNoteBook = tkinter.Frame(Tempframe,border=10,bg='turquoise2')
    ...
    IndiaNoteBook = tkinter.Frame(Tempframe,border=10,bg='turquoise2')
    Tempframe.add(IndiaNoteBook, text="India_Dataset")

    interfaceIndia.IndiaBox(
        IndiaNoteBook, "India Analysis", "Enter Month (required)", 0)

    USANoteBook = tkinter.Frame(Tempframe,border=10,bg='turquoise2')
