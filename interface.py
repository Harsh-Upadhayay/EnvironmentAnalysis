...
def About(notebook):
    ...
    para2_1 = tkinter.Label(frame2, text="Numpy").grid(
        column=0, row=0, sticky=tkinter.W, padx=10, pady=10)
    para2_2 = tkinter.Label(frame2, text="Pandas").grid(
        column=0, row=1, sticky=tkinter.W, padx=10, pady=10)
    para2_3 = tkinter.Label(frame2, text="Matplotlib").grid(
        column=0, row=2, sticky=tkinter.W, padx=10, pady=10)
    para2_4 = tkinter.Label(frame2, text="Python GUI (Tkinter)").grid(
        column=0, row=2, sticky=tkinter.W, padx=10, pady=10)
